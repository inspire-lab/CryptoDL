...
# presicion = 2
# Chebyshev-l1-d2:
def polyReLUIntegSmall1( x ):
    return 0.0953305002073856 * x ** 3 + 0.25 * x ** 2 + 0.216745680916852 * x
...
def polyReLUInteg10( x ):
    return 1000 * 0.008 * x ** 2 + 1000 * 0.5 * x
...
#    return x**2
#    return 3*x**2 + x
    return -5 * x ** 3 + 5492795 * x ** 2 + 500000
#    return 86*x**2 + x
#    return 0.0004*x**2 + 0.5*x
#    return 0.00044*x**2 + 0.5*x
...
for name, data in inspect.getmembers( this, inspect.isfunction ):
    tf.keras.utils.get_custom_objects().update( { name : data  } )
    functions[ name ] = data
